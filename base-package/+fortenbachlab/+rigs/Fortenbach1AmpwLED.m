classdef Fortenbach1AmpwLED < symphonyui.core.descriptions.RigDescription
    
    methods
        
        function obj = Fortenbach1AmpwLED()
...
%             obj.addDevice(temperature);
            ...
            filterWheel = devices.FilterWheelDevice('comPort', 'COM10');
